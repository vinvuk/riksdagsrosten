                    ...
                    <tr key={vote.votering_id}>
                      <td className="w-full max-w-0 py-4 pr-3 pl-4 text-sm font-medium text-base-content sm:w-auto sm:max-w-none sm:pl-0">
                        ...
                        <dl className="font-normal lg:hidden">
                          ...
                          <dd className="mt-1 truncate text-base-content/70">
                            {committee?.name || vote.organ}
                          </dd>
                          <dt className="sr-only sm:hidden">Rubrik</dt>
                          <dd className="mt-1 truncate text-base-content/50 sm:hidden">
                            {vote.rubrik || vote.titel}
                          </dd>
                          <dt className="sr-only sm:hidden">Datum</dt>
                          <dd className="mt-1 text-base-content/50 sm:hidden">
                            {vote.datum}
                          </dd>
                        </dl>
                      </td>
                      <td className="hidden px-3 py-4 text-sm text-base-content/60 lg:table-cell">
                        {committee ? (
                      ...
                      <td className="hidden px-3 py-4 text-sm text-base-content/60 sm:table-cell max-w-xs truncate">
                        {vote.rubrik || vote.titel}
                      </td>
                      ...
                      <td className="hidden px-3 py-4 text-sm text-base-content/60 whitespace-nowrap sm:table-cell">
                        {vote.datum}
                      </td>
                    </tr>
                  );
